...
import { TypeStructureService } from 'src/app/core/_services/type-structure.service';
...
export class TypeStructureComponent implements OnInit {
  ...
  create(value){
      this.tsService.create(value).subscribe((res:any)=>{
  ...
  setState(value){
    this.tsService.setState(this.selected_data?.id,value).subscribe((res:any)=>{
