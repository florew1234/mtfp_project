...
import { Nature } from '../../../../core/_models/nature.model';
import { LocalService } from '../../../../core/_services/browser-storages/local.service';


@Component({
  selector: 'app-listenature',
  templateUrl: './listenature.component.html',
  styleUrls: ['./listenature.component.css']
})
export class ListenatureComponent implements OnInit {
  ...
  create(value){
    ...
    this.natureService.create(value).subscribe((res:any)=>{
