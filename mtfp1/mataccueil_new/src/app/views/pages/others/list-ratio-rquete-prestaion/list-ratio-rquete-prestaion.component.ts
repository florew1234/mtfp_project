...
@Component({
  selector: 'app-list-ratio-rquete-prestaion',
  templateUrl: './list-ratio-rquete-prestaion.component.html',
  styleUrls: ['./list-ratio-rquete-prestaion.component.css']
})
export class ListRatioRquetePrestaionComponent implements OnInit {
  ...
  init(){
    this._temp=[]
    this.data=[]
    this.requeteService.getRationReqPrestation({"startDate":"all","endDate":"all"},this.user.idEntite).subscribe((res:any)=>{
      this.spinner.hide();
      this.data=res
    ...
    this._temp2=[]
    this.data2=[]
    this.requeteService.getRationReqPrestationEncours({"startDate":"all","endDate":"all"},this.user.idEntite).subscribe((res:any)=>{
      this.spinner.hide();
      this.data2=res
