...
@Component({
  selector: 'app-list-ratio-demande-infos-structure',
  templateUrl: './list-ratio-demande-infos-structure.component.html',
  styleUrls: ['./list-ratio-demande-infos-structure.component.css']
})
export class ListRatioDemandeInfosStructureComponent implements OnInit {
  ...
  init(){
    this._temp=[]
    this.data=[]
    this.requeteService.getRationInfosStructure({"startDate":"all","endDate":"all"},this.user.idEntite).subscribe((res:any)=>{
      this.spinner.hide();
      this.data=res
    ...
    this._temp2=[]
    this.data2=[]
    this.requeteService.getRationInfosStructureEncours({"startDate":"all","endDate":"all"},this.user.idEntite).subscribe((res:any)=>{
      this.spinner.hide();
      this.data2=res
