...
@Component({
  selector: 'app-list-ratio-plainte-structure',
  templateUrl: './list-ratio-plainte-structure.component.html',
  styleUrls: ['./list-ratio-plainte-structure.component.css']
})
export class ListRatioPlainteStructureComponent implements OnInit {
  ...
  init(){
    this._temp=[]
    this.data=[]
    this.requeteService.getRationPlainteStructure({"startDate":"all","endDate":"all"},this.user.idEntite).subscribe((res:any)=>{
      this.spinner.hide();
      this.data=res
    ...
    this._temp2=[]
    this.data2=[]
    this.requeteService.getRationPlainteStructureEncours({"startDate":"all","endDate":"all"},this.user.idEntite).subscribe((res:any)=>{
      this.spinner.hide();
      this.data2=res
