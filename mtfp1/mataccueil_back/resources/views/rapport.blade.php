...
<body>
    ...
    <div class="limiter">
        <div class="container-table100">
            <h3 class="text-center" style="text-transform: uppercase;"><strong>Traitement des plaintes (PL.)</strong><br/> {{$periode}}</h3>
			<div>
				<div>
            ...
            <hr/>
            <h3 class="text-center" style="text-transform: uppercase;"><strong>Traitement des Requêtes (R) {{$periode}}</strong></h3>
			<div>
				<div>
                    <table class="tb" style="border : 1px solid black; width : 100%;">
						<thead>
                            <tr>
                                ...
                                <th class="tb cent">TOTAL</th>
								<th class="tb cent">R. T</th>
								<th class="tb cent">R. N.T</th>
								<th class="tb cent">% R. N.T</th>
								<th class="tb cent">OBSERV.</th>
								<th class="tb cent">Archivée</th>
								<!-- <th class="tb cent">% R. T. D.D.</th>
								<th class="tb cent">OBSERV.</th> -->
							</tr>
						</thead>
                        @if(count($datasreq) != 0)
                            ...
                            @foreach($datasreq as $dtreq)
								<tr>
                                    ...
                                    @else
                                        ...
                                        <td class="tb" >{{$dtreq['archiveReq']}}</td>
                                        <!-- <td class="tb" <?php 
                                            $obsreq = "";
            ...
            <hr/>
            <h3 class="text-center" style="text-transform: uppercase;"><strong>Traitement des demandes d'information (DI) {{$periode}}</strong></h3>
			<div>
				<div>
                    <table class="tb" style="border : 1px solid black; width : 100%;">
						<thead>
                            <tr>
                                <th class="tb">STRUCT.</th>
                                <th class="tb cent">TOTAL</th>
								<th class="tb cent">DI. T</th>
								<th class="tb cent">DI. N.T</th>
								<th class="tb cent">% DI. N.T</th>
								<th class="tb cent">OBSERV.</th>
								<th class="tb cent">Archivée</th>
								<!-- <th class="tb cent">% DI. T. D.D.</th>
								<th class="tb cent">OBSERV.</th> -->
							</tr>
						</thead>
                        @if(count($datasDem) != 0)
						<tbody>
                            @foreach($datasDem as $dtreq)
								<tr>
									<td class="ts" style="padding:8px" >{{$dtreq['strcuture']}}</td>
                                    <td class="tb" >{{$dtreq['Treq']}}</td>
									<td class="tb" >{{$dtreq['reqTrai']}}</td>
            ...
            <hr/>
            <h3 class="text-center " style="text-transform: uppercase;"><strong>STATISTIQUE DES VISITES DES CCSP ET DES GSRU </strong><br/> {{$periode}}</h3>
            <div>
                <div>
                    <table class="tb" style="border : 1px solid black; width : 100%;">
                        <thead>
            ...
            <hr/>
            <h3 class="text-center " style="text-transform: uppercase;"><strong>SUIVI du traitement des préoccupations remontées par les PFC </strong><br/> {{$periode}}</h3>
            <div>
                <div>
                    <table class="tb" style="border : 1px solid black; width : 100%;">
                        <thead>
    ...
    <table>
        <tr>
            ...
            <th class="legendedir"><strong>R </strong> : Requêtes </th>
            <th class="legendedir"><strong>DI </strong> : Demandes d'informations </th>
        </tr>
        <tr>
            <th class="legendepl"><strong>PL. T </strong> : Plaintes traitées</th>
            <th class="legendedir"><strong>R.T </strong> : Requêtes traitées </th>
            <th class="legendedir"><strong>DI.T </strong> : Demandes d'informations traitées </th>
        </tr>
        <tr>
            <th class="legendepl"><strong>PL.N.T </strong> : Plaintes non traitées</th>
            <th class="legendedir"><strong>R.N.T </strong> : Requêtes non traitées </th>
            <th class="legendedir"><strong>DI.N.T </strong> : Demandes d'informations non traitées </th>
        </tr>
        <tr>
            <th class="legendepl"></th>
            <th class="legendedir"><strong>R. T. D.D. </strong> : Requêtes traitées dans les délais</th>
            <th class="legendedir"><strong>DI. T. D.D. </strong> : Demandes d'informations traitées dans les délais</th>
        </tr><br><br>
        <tr>
