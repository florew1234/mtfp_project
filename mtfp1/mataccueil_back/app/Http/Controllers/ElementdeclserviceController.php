...
class ElementdeclserviceController extends Controller {
	...
	public function index($idEntite)
	{
		try { 
			...
			$ElementdeclserviceSearch = Elementdeclservice::where('idEntite',$idEntite)->get();

			return $ElementdeclserviceSearch;
